...
public class ThreeMusketeers {
    ...
    protected void move(final Agent agent) { 
    	// TODO
    	Move aMove = agent.getMove();//get a valid move
    	//if null
    	if (aMove == null) {
    		//System.out.println("shinull");
    		
    		return;
    	}
    	else if (board.isValidMove(aMove)) {
    		moves.add(new Move(aMove));
    		board.move(aMove);
    	}
    	//System.out.println("haonan");
    	return;
